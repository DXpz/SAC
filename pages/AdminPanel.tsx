        ...
        >
          ...
          <div className="flex items-start justify-between mb-2 pr-8">
            <div className="flex-1">
              ...
              <p className="text-[10px] mt-1" style={{color: styles.text.tertiary}}>
                {usuariosPorRol.agente} agentes • {usuariosPorRol.supervisor} supervisores{usuariosPorRol.admin > 0 ? ` • ${usuariosPorRol.admin} admin` : ''}{usuariosPorRol.gerente > 0 ? ` • ${usuariosPorRol.gerente} gerentes` : ''}
              </p>
            </div>
          </div>
        </div>
